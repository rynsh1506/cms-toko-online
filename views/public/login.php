...
<body class="flex h-screen overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-300">
    ...
    <div class="w-full lg:w-[38.2%] flex flex-col justify-center px-8 sm:px-12 md:px-16 lg:px-12 xl:px-16 overflow-y-auto bg-slate-50 dark:bg-slate-950 relative">
        ...
        <div class="w-full max-w-md mx-auto my-auto py-12">
            ...
            <div class="mb-8">
                <h2 class="text-3xl font-bold text-slate-800 dark:text-white font-display">Selamat datang kembali!</h2>
            ...
            <form id="login-form" action="index.php?page=auth_process&action=login" method="POST" class="space-y-4">
                ...
                <button type="submit" id="btn-login"
                    class="w-full bg-primary text-white font-bold py-3 px-4 rounded-xl hover:opacity-90 active:scale-[0.98] transition shadow-lg shadow-primary/10 text-sm mt-2">
                    Masuk
                </button>
            </form>
