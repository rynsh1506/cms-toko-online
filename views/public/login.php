...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form action="index.php?page=auth_process&action=login" method="POST">
            <div class="mb-4">
        ...
        <p class="text-center text-sm text-gray-600 mt-4">
            Belum punya akun? <a href="index.php?page=register" class="text-blue-500 hover:underline">Register</a>
        </p>
    </div>
