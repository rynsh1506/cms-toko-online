<?php
// Variables $order, $configs, $primary_color, $items, $wa_link, $wa_message
// are provided by InvoiceViewController.php
?>
<!DOCTYPE html>
<html lang="id">
<head>
            ...
            <?php if ($order['status'] !== 'cancelled'): ?>
                <div class="p-8 bg-indigo-50/50 dark:bg-indigo-950/20 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6 print:hidden">
                    ...
                    <div class="flex gap-3 w-full md:w-auto">
                        ...
                        <a href="<?= esc($wa_link) ?>" target="_blank" class="w-full md:w-auto bg-green-500 hover:bg-green-600 text-white font-bold py-2.5 px-5 rounded-xl shadow-lg shadow-green-500/10 transition flex items-center justify-center space-x-2 text-xs">
