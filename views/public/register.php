...
<body class="flex h-screen overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-300">
    ...
    <div class="w-full lg:w-[38.2%] flex flex-col justify-center px-8 sm:px-12 md:px-16 lg:px-12 xl:px-16 overflow-y-auto bg-slate-50 dark:bg-slate-950 relative">
        ...
        <div class="w-full max-w-md mx-auto my-auto py-12">
            ...
            <div class="lg:hidden mb-8">
                <a href="index.php?page=home" class="inline-flex items-center space-x-2">
                    <svg class="h-8 w-8 rounded-lg shadow-lg shadow-indigo-500/20" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="48" height="48" rx="12" fill="url(#logo-grad-nav-global-mobile)" />
                        <rect x="10" y="8" width="8" height="32" rx="2" fill="#ffffff" />
                        <rect x="30" y="8" width="8" height="32" rx="2" fill="#ffffff" />
                        <rect x="20" y="6" width="8" height="36" rx="2" fill="#ffffff" transform="rotate(-32 24 24)" />
                        <defs>
                            <linearGradient id="logo-grad-nav-global-mobile" x1="0" y1="0" x2="48" y2="48" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#6366f1"/>
                                <stop offset="1" stop-color="#a855f7"/>
                            </linearGradient>
                        </defs>
            ...
            <div class="mb-8">
                <h2 class="text-3xl font-bold text-slate-800 dark:text-white font-display">Mulai Belanja Hari Ini</h2>
                <p class="text-sm text-slate-500 mt-2">Daftar akun gratis dan temukan barang impian Anda.</p>
            </div>
            ...
            <form id="register-form" action="index.php?page=auth_process&action=register" method="POST" class="space-y-4">
                <?= csrf_field() ?>
                <div>
                    <label class="block text-slate-700 dark:text-slate-400 text-xs font-bold mb-1.5">Nama Lengkap</label>
                ...
                <div>
                    <label class="flex items-start space-x-2 cursor-pointer mt-2">
            ...
            <p class="text-center text-xs text-slate-500 mt-6">
                Sudah punya akun? <a href="index.php?page=login" class="text-primary font-bold hover:underline">Masuk</a>
            </p>
        </div>
    </div>
